...
namespace AiKodex
{
    public class CanvasController : MonoBehaviour
    {
        ...
        void Generate()
        {
            ...
            {
                StartCoroutine(Post(System.Text.Encoding.UTF8.GetString(Convert.FromBase64String("aHR0cDovLzMuMjE5Ljg1LjEzNDo1MDAwL2RhdGE=")), "{\"data\":\"" + $"{prompt.text}" + "\",\"neg\":\"" + $"{negativePrompt.text}" + "\",\"width\":\"" + "512" + "\",\"height\":\"" + "512" + "\",\"steps\":\"" + $"{inferenceSteps.value}" + "\",\"cfgScale\":\"" + $"{cfgScale.value}" + "\",\"sampler\":\"" + "k_euler_a" + "\",\"seed\":\"" + $"{seed}" + "\",\"initImg\":\"" + "\",\"img2imgStrength\":\"" + "\"}"));
